            ...
            <div class="col s12 m6 offset-m3 offset-m3">
                ...
                <div class="card-panel z-depth-2" id="login">
                    ...
                    <?php
                        if(isset($_REQUEST['submit'])){
                            ...
                            if($_REQUEST['username'] == "" || $_REQUEST['password'] == ""){
                                ...
                                <a class="btn-large waves-effect waves-light green draken col s11" href="./" style="margin: 20px 0 0 5px;"><i class="material-icons md-24">arrow_back</i> Kembali ke login form</a></div>';
                            } else {
                    ...
                    <form class="col s12 m12 offset-4 offset-4" method="POST" action="" >
                        ...
                        <div class="input-field col s12">
                            <button type="submit" class="btn-large waves-effect waves-light green draken col s12" name="submit">LOGIN</button>
                        </div>
                    </form>
                    <!-- Form END -->
                    <?php
