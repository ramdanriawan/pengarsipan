                        ...
                        <div class="col s12">
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1 hijau hijau">
                                        <div class="col m12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light hijau"><a href="?page=gsm" class="judul"><i class="material-icons">image</i> Galeri File Surat Masuk</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
                                    ...
                                    if(in_array($eks, $ekstensi) == true){
                                        echo '
                                            <div class="col m3">
                                                ...
                                                <a class="btn light-green darken-1 hijau hijau" href="?page=gsm&act=fsm&id_surat='.$row['id_surat'].'">Tampilkan Ukuran Penuh</a>
                                            </div>';
                                    } else {
                                        ...
                                        if(in_array($eks, $ekstensi2) == true){
                                            echo '
                                                <div class="col m3">
                                                    ...
                                                    <a class="btn light-green darken-1 hijau hijau" href="?page=gsm&act=fsm&id_surat='.$row['id_surat'].'">Lihat Detail File</a>
                                                </div>';
                                        } else {
                                            echo '
                                                <div class="col m3">
