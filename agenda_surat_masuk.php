                            ...
                            <div class="z-depth-1">
                                <nav class="secondary-nav">
                                    <div class="nav-wrapper blue-grey darken-1 hijau">
                                        <div class="col 12">
                                            <ul class="left">
                                                <li class="waves-effect waves-light hijau"><a href="?page=asm" class="judul"><i class="material-icons">print</i> Cetak Agenda Surat Masuk<a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </nav>
            ...
            echo '
                        ...
                        <div class="z-depth-1">
                            <nav class="secondary-nav">
                                <div class="nav-wrapper blue-grey darken-1 hijau">
                                    <div class="col 12">
                                        <ul class="left">
                                            <li class="waves-effect waves-light hijau"><a href="?page=ask" class="judul"><i class="material-icons">print</i> Cetak Agenda Surat Masuk<a></li>
                                        </ul>
                                    </div>
                                </div>
                            </nav>
                ...
                <div class="row jarak-form black-text">
                    <form class="col s12" method="post" action="">
                        ...
                        <div class="col s6">
                            <button type="submit" name="submit" class="btn-large blue waves-effect waves-light hijau hijau"> TAMPILKAN <i class="material-icons">visibility</i></button>
                        </div>
                    </form>
                </div>
                <!-- Row form END -->';
