...
<div class="container">
    ...
    <div class="footer-copyright green darken-1 white-text">
        <div class="container" id="footer">
            ...
            <span class="white-text">&copy; <?php echo date("Y"); ?>
                <?php
                    if(!empty($data['nama'])){
                        echo $data['nama']/* .' &nbsp;|&nbsp; <a class="white-text" href="http://pustekolah.org" target="_blank">By Novia Lestari</a>'*/;
                    } else {
                        echo '2017 PUSLITBANG  &nbsp;|&nbsp; <a class="white-text" href="http://pustekolah.org" target="_blank">By Novia Lestari</a>';
                    }
                ?>
            </a>
            </span>
            <div class="right hide-on-small-only">
                <?php
                    if(!empty($data['website'])){
                        ...
                        echo '<i class="material-icons md-12">public</i> www.pustekolah.org &nbsp;&nbsp;';
                    }
                    if(!empty($data['email'])){
                        echo '<i class="material-icons">mail_outline</i> '.$data['email'].'';
                    } else {
                        echo '<i class="material-icons">mail_outline</i>   fpc.052017@gmail.com';
                    }
                }
                ?>
            </div>
