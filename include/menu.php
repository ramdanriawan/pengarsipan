...
<nav class="green darken-1">
    <div class="nav-wrapper">
        <a href="./" class="brand-logo center hide-on-large-only"><i class="material-icons md-36">home</i>PUSLITBANG</a>
        <ul id="slide-out" class="side-nav" data-simplebar-direction="vertical">
            <li class="no-padding">
                <div class="logo-side center green darken-3">
                    <?php
                        ...
                        while($data = mysqli_fetch_array($query)){
                            ...
                            if(!empty($data['nama'])){
                                echo '<h5 class="puslitbang-side">'.$data['nama'].'</h5>';
                            } else {
                                echo '<h5 class="puslitbang-side">Pusat Penelitian Dan Pengembangan Hasil Hutan</h5>';
                            }
                            if(!empty($data['alamat'])){
                                echo '<p class="description-side">'.$data['alamat'].'</p>';
                            } else {
                                echo '<p class="description-side">Jalan Gunung Batu No.5 Bogor 16610.</p>';
                            }
                        }
                    ?>
                </div>
            </li>
            <li class="no-padding green darken-4">
        ...
        <ul class="center hide-on-med-and-down" id="nv">
            <li><a href="./" class="ams hide-on-med-and-down"><i class="material-icons md-36">home</i>PUSLITBANG</a></li>
            <li><div class="grs"></></li>
