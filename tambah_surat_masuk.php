                            ...
                            if(!preg_match("/^[a-zA-Z0-9.,_()%&@\/\r\n -]*$/", $isi)){
                                ...
                                if(!preg_match("/^[0-9.-]*$/", $tgl_diterima)){
                                    ...
                                    if(!preg_match("/^[a-zA-Z0-9., -]*$/", $input)){
                                        $_SESSION['input'] = 'Form Input hanya boleh mengandung karakter huruf, angka, spasi, titik(.) dan koma(,) dan minus (-)';
                                        echo '<script language="javascript">window.history.back();</script>';
                                    } else {
                    ...
                    <div class="row">
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi dengan angka">
                         ...
                         <div class="input-field col s6">
                            ...
                            <input id="tgl_diterima" type="text" name="tgl_diterima" class="datepicker2" required>
                                <?php
                                    if(isset($_SESSION['tgl_diterima'])){
                                        $tgl_diterima = $_SESSION['tgl_diterima'];
                                        echo '<div id="alert-message" class="callout bottom z-depth-1 red lighten-4 red-text">'.$tgl_diterima.'</div>';
                                        unset($_SESSION['tgl_diterima']);
                                    }
                                ?>
                        ...
                        <div class="input-field col s6 tooltipped" data-position="top" data-tooltip="Isi dengan huruf atau angka">
                            ...
                            <input id="indeks" type="text" class="validate" name="input" required>
                                ...
                                ?>
                            <label for="indeks">Di Inputkan Oleh</label>
                        </div>
                        <div class="input-field col s6">
