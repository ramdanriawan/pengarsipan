<?php
    ...
    if(empty($_SESSION['admin'])){
        ...
        <div class="container">
            <div id="colres">
                <div class="disp">';
                    $query3 = mysqli_query($config, "SELECT institusi, nama, status, alamat, logo FROM tbl_instansi");
                    list($institusi, $nama, $status, $alamat, $logo) = mysqli_fetch_array($query3);
                    if(!empty($logo)){
                    ...
                    if(!empty($institusi)){
                        ...
                        echo '<h6 class="up">Pusat Penelitian Dan Pengembangan</h6>';
                    }
                    if(!empty($nama)){
                        echo '<h5 class="up" id="nama">'.$nama.'</h5><br/>';
                    } else {
                        echo '<h5 class="up" id="nama">Hasil Hutan</h5><br/>';
                    }
                    if(!empty($status)){
                        echo '<h6 class="status">'.$status.'</h6>';
                    } else {
                        echo '<h6 class="status">Aktif</h6>';
                    }
                    if(!empty($alamat)){
                        echo '<span id="alamat">'.$alamat.'</span>';
                    } else {
                        echo '<span id="alamat">Jl. Gunung Batu No.5 Bogor 16610.
</span>';
                    }
                    echo '
                </div>
                ...
                echo '
                    <table class="bordered" id="tbl">
                        <tbody>
                            ...
                            <tr>
                                <td id="right" width="18%"><strong>Di Inputkan Oleh</strong></td>
                                <td id="left" style="border-right: none;" width="57%">: '.$row['input'].'</td>
                            ...
                            <tr class="isi">
                                ...
                                $y3 = substr($row['batas_waktu'],0,4);
                                $m3 = substr($row['batas_waktu'],5,2);
                                $d3 = substr($row['batas_waktu'],8,2);
                                ...
                                echo '
									<strong>Batas Waktu</strong> : '.$d3." ".$nm3." ".$y3.'<br/>
            ...
            <div id="lead">
                ...
                if(!empty($kepala)){
                    ...
                    echo '<p class="lead">Dr.Ir. Dwi Sudharto, M.Si.
</p>';
                }
                if(!empty($nip)){
                    echo '<p>NIP. '.$nip.'</p>';
